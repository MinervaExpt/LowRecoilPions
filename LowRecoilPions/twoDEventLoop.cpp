...
/*  
  ...
  */
  ...
  std::vector<double> tpibins = {1., 10., 15., 20., 25., 30., 36., 42., 48., 54.,60., 66., 72., 78.,  84., 90., 100., 110., 125., 140., 155., 175., 200., 225., 250., 275., 300., 325., 350., 400., 500., 700., 1000.}; 
  ...
  std::vector<double> tpibinsGEV = {.001, .010, .015, .020, .025, .030, .036, .042, .048, .054,.060, .066, 0.072, 0.078,.084, 0.09, .100, .110, .125 , .140 , .155, .175, .200, .225, .250, .275, .300, .325, .350, .400, .500,0.700, 1.0}; 
