...
tarfile=sultana_Mnv431_PionWeight_notonCOH_bkgTuning_June132023.tgz 
...
subdir=June132023_PionWeight_notonCoh_bkgtuning #June11_nobkgtune_collabtalk
weightapply=WithPionWeight_notOnCoh_bkgtuning
...
do
	...
	playlistname=me${val}_12GBmem_12GBdisk_60hlife
