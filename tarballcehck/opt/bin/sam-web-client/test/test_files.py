...
class TestDefinition(testbase.SamdevTest):
    ...
    def test_listFiles(self):
        ...
        assert hasattr(files, 'next') or hasattr(files,'__next__') # __next__ is Python 3's version
        filelist = list(files)
        assert len(filelist)==1 and filelist[0]=="MN_00000798_0004_numib_v04_0911090239_RawEvents.root"
...
class TestLocation(testbase.SamdevTest):
    ...
    def test_locateFile(self):
        ...
        assert set([l["full_path"] for l in locations]) == set(['enstore:/pnfs/samdev/rawdata/raw/numib/00/00/07/98', 'samdevdata:/grid/data/samdev/data01', 'cern-eos:/fake/path/to/the/file'])
    ...
    def test_locateFiles(self):
        ...
        assert set([l["full_path"] for l in locations['MN_00000798_0004_numib_v04_0911090239_RawEvents.root']]) == set(['enstore:/pnfs/samdev/rawdata/raw/numib/00/00/07/98', 'samdevdata:/grid/data/samdev/data01', 'cern-eos:/fake/path/to/the/file'])
    ...
    def test_fileUrl(self):
        ...
        assert set(urls) == set(['gsiftp://fg-bestman1.fnal.gov:2811/grid/data/samdev/data01/MN_00000798_0004_numib_v04_0911090239_RawEvents.root',
            ...
            'gsiftp://eospublicftp.cern.ch/fake/path/to/the/file/MN_00000798_0004_numib_v04_0911090239_RawEvents.root'])
