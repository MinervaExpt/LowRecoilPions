universe          = vanilla
executable        = /fife/local/scratch/uploads/minerva/sultana/2023-01-23_190544.782441_2873/runEventLoopSide_job.sh_20230123_190546_2150153_0_1_wrap.sh
arguments         =  data_me1A_xrootd_plist.txt  mc1_me1A_xrootd_plist.txt 
output                = /fife/local/scratch/uploads/minerva/sultana/2023-01-23_190544.782441_2873/runEventLoopSide_job.sh_20230123_190546_2150153_0_1_cluster.$(Cluster).$(Process).out
error                 = /fife/local/scratch/uploads/minerva/sultana/2023-01-23_190544.782441_2873/runEventLoopSide_job.sh_20230123_190546_2150153_0_1_cluster.$(Cluster).$(Process).err
log                   = /fife/local/scratch/uploads/minerva/sultana/2023-01-23_190544.782441_2873/runEventLoopSide_job.sh_20230123_190546_2150153_0_1_.log
environment   = CLUSTER=$(Cluster);PROCESS=$(Process);CONDOR_TMP=/fife/local/scratch/uploads/minerva/sultana/2023-01-23_190544.782441_2873;CONDOR_EXEC=/tmp;DAGMANJOBID=$(DAGManJobId);IFDH_CP_MAX_RETRIES=1;GRID_USER=sultana;IFDH_BASE_URI=http://samweb.fnal.gov:8480/sam/minerva/api;JOBSUBJOBID=$(CLUSTER).$(PROCESS)@jobsub03.fnal.gov;EXPERIMENT=minerva
rank                  = Mips / 2 + Memory
...
transfer_input_files = /fife/local/scratch/uploads/minerva/sultana/2023-01-23_190544.782441_2873/runEventLoopSide_job.sh
