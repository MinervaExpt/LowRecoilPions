...
class CVUniverse : public PlotUtils::MinervaUniverse {
  ...
  */
  ...
  virtual double GetTpiFromRange(double range) const{
     ...
     //std::cout << "Printing path of install dir " << std::string(mweightsfilelocation) << std::endl;
     std::string f = std::string(mweightsfilelocation) + "/TpiRange_Mediangraph.root";
     //"/minerva/app/users/sultana/cmtuser/WorkingArea/LowRecoilPions/LowRecoilPions/util/TpiRange_Mediangraph.root"; //"util/TpiRange_Mediangraph.root";
