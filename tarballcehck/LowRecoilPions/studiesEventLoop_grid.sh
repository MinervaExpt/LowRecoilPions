...
usr/bin/time -v -o studiesEventLoopTime.txt twoDEventLoopSide LowRecoilPions/playlists/$1 LowRecoilPions/playlists/$2 > Dump_runEventLoop.txt
#/usr/bin/time -v -o studiesEventLoopTime.txt twoDEventLoop LowRecoilPions/playlists/$1 LowRecoilPions/playlists/$2 > Dump_runEventLoop.txt
#/usr/bin/time -v -o studiesEventLoopTime.txt studiesEventLoop LowRecoilPions/playlists/$1 LowRecoilPions/playlists/$2 > Dump_studiesEventLoop.txt
