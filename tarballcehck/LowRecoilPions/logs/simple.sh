...
redirect_output_finish(){
    ...
    IFDH_CP_MAXRETRIES=1 ${JSB_TMP}/ifdh.sh cp ${JSB_TMP}/JOBSUB_ERR_FILE.truncated https://fndcadoor.fnal.gov:2880/fermigrid/jobsub/jobs/2023_03_06/f2d3873e-1a97-43fc-abb5-7257c9b5f4e1/runEventLoop_lite.sh2023_03_06_122717f2d3873e-1a97-43fc-abb5-7257c9b5f4e1cluster.$CLUSTER.$PROCESS.err
    IFDH_CP_MAXRETRIES=1 ${JSB_TMP}/ifdh.sh cp ${JSB_TMP}/JOBSUB_LOG_FILE.truncated https://fndcadoor.fnal.gov:2880/fermigrid/jobsub/jobs/2023_03_06/f2d3873e-1a97-43fc-abb5-7257c9b5f4e1/runEventLoop_lite.sh2023_03_06_122717f2d3873e-1a97-43fc-abb5-7257c9b5f4e1cluster.$CLUSTER.$PROCESS.out
    # copy script and jdf out to dcache sandbox
    if [ "$PROCESS" -eq 0 ]; then
        IFDH_CP_MAXRETRIES=0 ${JSB_TMP}/ifdh.sh cp $JOBSUB_EXE_SCRIPT https://fndcadoor.fnal.gov:2880/fermigrid/jobsub/jobs/2023_03_06/f2d3873e-1a97-43fc-abb5-7257c9b5f4e1/runEventLoop_lite.sh
        
        IFDH_CP_MAXRETRIES=0 ${JSB_TMP}/ifdh.sh cp simple.cmd https://fndcadoor.fnal.gov:2880/fermigrid/jobsub/jobs/2023_03_06/f2d3873e-1a97-43fc-abb5-7257c9b5f4e1/simple.cmd
    fi
...
# --tar_file_name for input
    ...
    # RCDS unpacked tarfile
      ...
      INPUT_TAR_DIR_LOCAL=/cvmfs/fifeuser1.opensciencegrid.org/sw/minerva/2aee2c9a1f28779d09f63eb4daa6c2c60dfd4dc4548e955805871cfe761036bd
      export INPUT_TAR_DIR_LOCAL
      # Note: this filename doesn't exist, but if you take dirname
      #       of it you find the contents
      INPUT_TAR_FILE=/cvmfs/fifeuser1.opensciencegrid.org/sw/minerva/2aee2c9a1f28779d09f63eb4daa6c2c60dfd4dc4548e955805871cfe761036bd/sultana_MnvTunev431PionReweightBkgTune_MehreenCuts.tar
      export INPUT_TAR_FILE
      ln -s /cvmfs/fifeuser1.opensciencegrid.org/sw/minerva/2aee2c9a1f28779d09f63eb4daa6c2c60dfd4dc4548e955805871cfe761036bd ${CONDOR_DIR_INPUT}/sultana_MnvTunev431PionReweightBkgTune_MehreenCuts
...
export JOBSUB_EXE_SCRIPT=$(ls runEventLoop_lite.sh 2>/dev/null)
if [ "$JOBSUB_EXE_SCRIPT" = "" ]; then
     export JOBSUB_EXE_SCRIPT=$(find . -name runEventLoop_lite.sh -print | head -1)
fi
chmod +x $JOBSUB_EXE_SCRIPT
${JSB_TMP}/ifdh.sh log "mengel:$JOBSUBJOBID BEGIN EXECUTION $JOBSUB_EXE_SCRIPT   data_me1A_xtest.txt mc_me1A_xtest.txt "
...
echo `date` $JOBSUBJOBID BEGIN EXECUTION $JOBSUB_EXE_SCRIPT data_me1A_xtest.txt mc_me1A_xtest.txt >&2
echo `date` $JOBSUBJOBID BEGIN EXECUTION $JOBSUB_EXE_SCRIPT data_me1A_xtest.txt mc_me1A_xtest.txt

 $JOBSUB_EXE_SCRIPT data_me1A_xtest.txt mc_me1A_xtest.txt
JOB_RET_STATUS=$?

# copy out -d directories

${JSB_TMP}/ifdh.sh cp -D $CONDOR_DIR_OUT/* /pnfs/minerva/scratch/users/sultana/GridJobs/MnvTunev431_PionReweight_BkgTune_submitted_2023_03_06_12_26_testjob_fullSystematics
...
${JSB_TMP}/ifdh.sh log "$JOBSUBJOBID sultana:runEventLoop_lite.sh COMPLETED with return code $JOB_RET_STATUS"
exit $JOB_RET_STATUS