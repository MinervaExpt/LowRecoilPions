...
var = "pion_angle" #"pion_angle_range4" #"permichel_pirange" #"NewEAvail" #"pTmu"
#var = "pion_angle"
dataName = var + "_data"
...
mcStack.SetMaximum(dataHistnorm.GetMaximum()*3.) #Make room for annotations above the plot
mcStack.Draw("HIST")
...
#legend = top.BuildLegend(0.60, 0.4, 0.9, 0.9) #TODO: Explain legend position.  ROOT 6 might even make an intelligent decision about where to place it.
...
ratio.GetXaxis().SetTitle("cos(#theta_{#pi})")
ratio.Draw()
