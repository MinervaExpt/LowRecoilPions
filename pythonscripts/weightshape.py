...
nwHist = nwFile.Get(var+"_data")#"GENIE_"+ var + "_RES")#"_efficiency_numerator")
wHist = wFile.Get(var+"_data")#"GENIE_"+var+ "_RES")#"_efficiency_numerator")
...
ratio.GetYaxis().SetTitle("Weight Shape")
...
overall.Print(var + "_AfterBefor_MC_20deg.png")
