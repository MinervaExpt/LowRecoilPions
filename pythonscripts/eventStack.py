...
for key in mcFile.GetListOfKeys():
  ...
  if name.find("top") > -1 and name.find(var+"_t") > -1:
    ...
    if newname.find("_top_COH_Pions") > -1:
			...
			hists[1] = hist.GetCVHistoWithError().Clone()#continue
...
dataWithStatErrors.GetYaxis().SetTitle("N Events")
...
overall.Print(var + "_" + sys.argv[4] + "_DataMCRatio.png")
