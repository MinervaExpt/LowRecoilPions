...
if i == int(sys.argv[3]):
	...
	colororder = [0, 1, 3, 2, 4, 5]	
		...
		newname = hist.GetName()
                if (newname.find("_top_") < 0): continue
	...
	orderedStack.SetMaximum(dataHistnorm.GetMaximum()*2.5) #Make room for annotations above the plot
