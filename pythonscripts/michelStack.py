...
var = "permichel_pirange"# "pion_angle" #"pTmu"
dataName = var + "_data"
...
dataFile = TFile.Open("July282022_EavailComp_noreweight_pTbin6_data.root")#runEventLoopData_July282022_EavailComp_pTbin6_noreweight.root")
mcFile = TFile.Open("July282022_EavailComp_noreweight_pTbin6_MC.root ")#July282022_Sideband_noreweight_pTbin6_MC.root")#runEventLoopMC_July282022_EavailComp_pTbin6_noreweight.root")
...
title.AddText("Pion Angle (cos#theta)")
title.Draw()
