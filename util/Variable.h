...
class Variable: public PlotUtils::VariableBase<CVUniverse>
{
  ...
  public:
                           ...
                           std::map<std::string, std::vector<CVUniverse*>>& truth_error_bands)
    {
      ...
      //std::vector<double> biasbins = {-2.6, -2.2,-1.8 ,-1.6, -1.4, -1.2 ,-1., -0.8, -0.6, -0.4, -0.2, -0.1, -0.05 ,0., 0.05, 0.1, 0.2, 0.4, 0.6, 0.8, 1., 1.2, 1.4, 1.6, 1.8, 2.2 , 2.6};
      //biasMCReco = new Hist((GetName() + "_resolution").c_str(), GetName().c_str(), biasbins, mc_error_bands);
