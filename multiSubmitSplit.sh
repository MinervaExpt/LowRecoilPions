...
declare -a playArray=("1D")
#("1M" "1N" "1P")
#("1A" "1B" "1C" "1D" "1E" "1F" "1L" "1M" "1N" "1O" "1P")
#declare -a playArray=("1A" "1E" "1D" )
#("1B" "1C" "1M" "1N" "1L" "1O" "1P")
#("1C" "1D" "1M" "1N" "1O" "1P")
#declare -a playArray=("1B" "1C" "1D" "1E" "1L" "1M" "1O" "1P")
tarfile=sultana_Mnv431_PionWeightCOHNeut_Nov092023.tgz
...
weightapply=Mnv431PionWeightCOHNeutMNP_trueEavminFixed
declare -a partsArray=("1" "2" "3")
for val in ${playArray[@]};
do

  for part in ${partsArray[@]};
     do
	playlistmc=p4_x_me${val}_central_mc${part}.txt
	playlistdata=p4_x_me${val}_central_data${part}.txt
	...
	playlistname=me${val}_part${part}_10GBmem_9GBdisk_60hlife
