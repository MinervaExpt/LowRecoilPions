universe          = vanilla
executable        = /fife/local/scratch/uploads/minerva/sultana/2023-01-23_103730.281700_5819/runEventLoop_job.sh_20230123_103731_1904788_0_1_wrap.sh
arguments         =  data_me1A_xrootd_plist.txt  mc_me1A_xrootd_plist.txt 
output                = /fife/local/scratch/uploads/minerva/sultana/2023-01-23_103730.281700_5819/runEventLoop_job.sh_20230123_103731_1904788_0_1_cluster.$(Cluster).$(Process).out
error                 = /fife/local/scratch/uploads/minerva/sultana/2023-01-23_103730.281700_5819/runEventLoop_job.sh_20230123_103731_1904788_0_1_cluster.$(Cluster).$(Process).err
log                   = /fife/local/scratch/uploads/minerva/sultana/2023-01-23_103730.281700_5819/runEventLoop_job.sh_20230123_103731_1904788_0_1_.log
environment   = CLUSTER=$(Cluster);PROCESS=$(Process);CONDOR_TMP=/fife/local/scratch/uploads/minerva/sultana/2023-01-23_103730.281700_5819;CONDOR_EXEC=/tmp;DAGMANJOBID=$(DAGManJobId);IFDH_CP_MAX_RETRIES=1;GRID_USER=sultana;IFDH_BASE_URI=http://samweb.fnal.gov:8480/sam/minerva/api;JOBSUBJOBID=$(CLUSTER).$(PROCESS)@jobsub02.fnal.gov;EXPERIMENT=minerva
rank                  = Mips / 2 + Memory
...
transfer_input_files = /fife/local/scratch/uploads/minerva/sultana/2023-01-23_103730.281700_5819/runEventLoop_job.sh
+JobsubClientDN="/DC=org/DC=cilogon/C=US/O=Fermi National Accelerator Laboratory/OU=People/CN=Mehreen Sultana/CN=UID:sultana"
...
+PNFS_INPUT_FILES = "/pnfs/minerva/resilient/tarballs/sultana_Jan202023_LowRecoilPions.tgz" 
