...
/usr/bin/time -v -o runEventLoopTime.txt twoDEventLoop $LOWREC_PREFIX/playlists/data_me1A_xtest.txt $LOWREC_PREFIX/playlists/mc_me1A_xtest.txt > Dump_runEventLoop.txt
